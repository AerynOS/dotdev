...
Our tooling is currently developed purely for making sure AerynOS is installed correctly and makes no consideration for other operating systems. As such, we highly recommend users stay from trying to dual boot with another OS from the same drive.
