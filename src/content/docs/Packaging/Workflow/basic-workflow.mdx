...
Once the [prerequisites](/packaging/workflow/prerequisites/) have been handled, it is time to learn how to install newly built local moss-format `.stone` packages.
