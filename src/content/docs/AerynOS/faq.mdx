...
Finally, join the [AerynOS Zulip space](https://aerynos.zulipchat.com/join/fuqokhsomj5mzqj6akqaiqlr/) and make sure to join the Packaging room.
...
- Then, share a link to your post in the [AerynOS Zulip space](https://aerynos.zulipchat.com/join/fuqokhsomj5mzqj6akqaiqlr/) in the General room so the link to the video doesn't get lost in the Zulip chat.
